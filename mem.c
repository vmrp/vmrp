...
int32 _mr_mem_init(void) {
    MRDBGPRINTF("initMemoryManager: baseAddress:0x%X len: 0x%X", MEMORY_MANAGER_ADDRESS, MEMORY_MANAGER_SIZE);
    Origin_LG_mem_base = getMrpMemPtr(MEMORY_MANAGER_ADDRESS);
    Origin_LG_mem_len = MEMORY_MANAGER_SIZE;
